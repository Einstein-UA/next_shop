...
interface ContextProps {
    ...
    scrollingFilterVisibility: boolean,
    setScrollingFilterVisibility: Dispatch<SetStateAction<boolean>>,
}
...
const ProductsFilterContext = createContext<ContextProps>({
    ...
    scrollingFilterVisibility: false,
...
export const ProductsFilterConextProvider = ({children}: any) => {
    ...
    const [scrollingFilterVisibility, setScrollingFilterVisibility] = useState<boolean>(false);
    return (
